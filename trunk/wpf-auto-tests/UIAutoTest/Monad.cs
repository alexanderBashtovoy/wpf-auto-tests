...
namespace Nova.Common.Utils
{
	public static class Monad
	{
		...
		public static Func<T, TResult> Safe<T, TResult, TException>(this Func<T, TResult> selector, Action<TException> handler = default(Action<TException>))
